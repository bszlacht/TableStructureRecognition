...
if __name__ == "__main__":
    cell_1_1 = Cell("text1", BBox(Point2D(0, 0), Point2D(1, 1)), 1)
    cell_1_2 = Cell("text2", BBox(Point2D(1, 0), Point2D(2, 1)), 1)
    cell_1_3 = Cell("text3", BBox(Point2D(2, 0), Point2D(3, 1)), 1)
    cell_2_1 = Cell("text4", BBox(Point2D(0, 1), Point2D(1, 2)), 1)
    cell_2_2 = Cell("text5", BBox(Point2D(1, 1), Point2D(2, 2)), 1)
    cell_2_3 = Cell("text6", BBox(Point2D(2, 1), Point2D(3, 2)), 1)
